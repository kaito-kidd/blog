---
title: Redis的持久化如何做的？RDB和AOF对比分析
date: 2020-06-30 12:28:32
categories: Redis
tags: [redis, RDB, AOF]
---

在上一篇文章中：[Redis高可用是如何做的？浅析哨兵的工作原理](http://kaito-kidd.com/2020/06/29/redis-high-availability/)，我们介绍了Redis高可用的实现方式，以及Redis哨兵的工作原理。
