---
title: Redis如何实现故障自动恢复？浅析哨兵的工作原理
date: 2020-07-02 12:14:09
categories: [Redis]
tags: [redis, 高可用]
---

前两篇文章：[Redis的持久化如何做的？RDB和AOF对比分析](http://kaito-kidd.com/2020/06/30/redis-persistence-rdb-aof/)和[Redis的主从复制是如何做的？复制过程中也会产生各种问题？](http://127.0.0.1:4000/2020/06/30/redis-replication/)分别介绍了Redis数据持久化和数据复制的工作流程和相关原理。
...
![](https://kaito-blog-1253469779.cos.ap-beijing.myqcloud.com/2020/06/15934011961428.jpg)
...
哨兵领导者给备选的master节点发送`slaveof no one`命令，让该节点成为master。
